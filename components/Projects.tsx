  ...
  return (
    <Section id="projects">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="relative w-full h-80 bg-gradient-to-br from-[#527dc1]/30 to-[#bb9af7]/30 flex items-center justify-center p-8">
          <div className="relative w-48 h-72 bg-[#1a1b26] rounded-2xl shadow-2xl border border-white/10 flex items-center justify-center">
            <span className="text-[#527dc1]/40 text-sm">Mobile Preview</span>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="flex gap-4">
            <motion.a
              ...
              className="inline-flex items-center gap-2 px-6 py-2 bg-[#527dc1] text-[#e0f2fe] rounded-lg font-medium hover:bg-[#4266a8] transition-all hover:scale-105 hover:shadow-lg hover:shadow-[#527dc1]/50 text-sm"
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-2 bg-transparent border border-[#527dc1] text-[#527dc1] rounded-lg font-medium hover:bg-[#527dc1]/10 transition-all hover:scale-105 text-sm"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
        ...
        >
          ...
          {/* Image Preview - Mobile Mockup */}
          <div className="relative w-full h-80 bg-gradient-to-br from-[#bb9af7]/30 to-[#7dcfff]/30 flex items-center justify-center p-8">
            <div className="relative w-48 h-72 bg-[#1a1b26] rounded-2xl shadow-2xl border border-white/10 flex items-center justify-center">
              <span className="text-[#bb9af7]/40 text-sm">Mobile Preview</span>
            </div>
          </div>
        ...
        >
          ...
          <div className="relative w-full h-80 bg-gradient-to-br from-[#7dcfff]/30 to-[#527dc1]/30 flex items-center justify-center p-8">
            <div className="relative w-full max-w-md h-60 bg-[#1a1b26] rounded-lg shadow-2xl border border-white/10">
              {/* Browser bar */}
              <div className="h-6 bg-[#24283b] rounded-t-lg border-b border-white/10 flex items-center px-3 gap-1.5">
                <div className="w-2 h-2 rounded-full bg-[#f7768e]"></div>
                <div className="w-2 h-2 rounded-full bg-[#e0af68]"></div>
                <div className="w-2 h-2 rounded-full bg-[#9ece6a]"></div>
              </div>
              {/* Content area */}
              <div className="flex items-center justify-center h-[calc(100%-24px)]">
                <span className="text-[#7dcfff]/40 text-sm">Desktop Preview</span>
              </div>
            </div>
          </div>
          ...
          {/* Content */}
          <div className="p-6">
            <h3 className="text-xl font-medium mb-2">Project Three</h3>
            <p className="text-[#a9b1d6] text-sm leading-relaxed mb-4">
        ...
        >
          ...
          {/* Image Preview - Desktop Mockup */}
          <div className="relative w-full h-80 bg-gradient-to-br from-[#bb9af7]/30 to-[#f7768e]/30 flex items-center justify-center p-8">
            <div className="relative w-full max-w-md h-60 bg-[#1a1b26] rounded-lg shadow-2xl border border-white/10">
              {/* Browser bar */}
              <div className="h-6 bg-[#24283b] rounded-t-lg border-b border-white/10 flex items-center px-3 gap-1.5">
                <div className="w-2 h-2 rounded-full bg-[#f7768e]"></div>
              ...
              {/* Content area */}
              <div className="flex items-center justify-center h-[calc(100%-24px)]">
                <span className="text-[#bb9af7]/40 text-sm">Desktop Preview</span>
              </div>
            </div>
          </div>
          ...
          {/* Content */}
          <div className="p-6">
            <h3 className="text-xl font-medium mb-2">Project Four</h3>
            <p className="text-[#a9b1d6] text-sm leading-relaxed mb-4">
